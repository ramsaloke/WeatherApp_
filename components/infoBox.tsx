    ...
    <div className="flex items-center justify-center text-center mt-2">
      <div className="w-full ">
        ...
        <Card className="w-full">
          ...
          />
          <CardContent>
            <Typography gutterBottom variant="h5" component="div" className="flex items-center justify-center">
              {dataInfo.city}{' '}
              {dataInfo.humidity > 80 ? <ThunderstormIcon className="ml-2" /> : dataInfo.temp > 18 ? <LightModeSharpIcon className="ml-2" /> : <AcUnitIcon className="ml-2" />}
            </Typography>
            <Typography variant="body2" component="span">
              <div className="text-gray-700 space-y-2">
                <p>
                  Temperature: <b>{dataInfo.temp}&deg;C</b>
                </p>
                <p>
                  Humidity: <b>{dataInfo.humidity}%</b>
                </p>
                <p>
                  Min Temperature: <b>{dataInfo.minTemp}&deg;C</b>
                </p>
                <p>
                  Max Temperature: <b>{dataInfo.maxTemp}&deg;C</b>
                </p>
                <p>
                  Weather can be described as <b>{dataInfo.description}</b> and feels like <b>{dataInfo.feelsLike}&deg;C</b>
                </p>
              </div>
            </Typography>
          </CardContent>
